...
{$M+}
  ...
  BMKFavPoiInfo = interface(NSObject)
    ['{9157D2A8-2982-4F91-BAD4-F8968727C2FE}']
    procedure setFavId(favId: NSString); cdecl;
  ...
  TBMKFavPoiInfo = class(TOCGenericImport<BMKFavPoiInfoClass, BMKFavPoiInfo>)
  end;
  ...
  BMKFavPoiManager = interface(NSObject)
    ...
    function addFavPoi(favPoiInfo: BMKFavPoiInfo): NSInteger; cdecl;
    function getFavPoi(favId: NSString): BMKFavPoiInfo; cdecl;
    function getAllFavPois: NSArray; cdecl;
    function updateFavPoi(favId: NSString; favPoiInfo: BMKFavPoiInfo)
      : Boolean; cdecl;
    function deleteFavPoi(favId: NSString): Boolean; cdecl;
    function clearAllFavPois: Boolean; cdecl;
  end;

  TBMKFavPoiManager = class(TOCGenericImport<BMKFavPoiManagerClass,
    BMKFavPoiManager>)
  end;
  ...
  BMKNaviPara = interface(NSObject)
    ...
    procedure setStartPoint(startPoint: BMKPlanNode); cdecl;
  ...
  TBMKNaviPara = class(TOCGenericImport<BMKNaviParaClass, BMKNaviPara>)
  end;
  ...
  BMKNavigationClass = interface(NSObjectClass)
    ...
    { class } function openBaiduMapNavigation(para: BMKNaviPara)
      : BMKOpenErrorCode; cdecl;
    { class } function openBaiduMapWalkNavigation(para: BMKNaviPara)
      : BMKOpenErrorCode; cdecl;
    { class } function openBaiduMapRideNavigation(para: BMKNaviPara)
      : BMKOpenErrorCode; cdecl;
    { class } function openBaiduMapwalkARNavigation(para: BMKNaviPara)
      : BMKOpenErrorCode; cdecl;
  end;
  ...
  TBMKNavigation = class(TOCGenericImport<BMKNavigationClass, BMKNavigation>)
  end;
  ...
  TBMKOpenOption = class(TOCGenericImport<BMKOpenOptionClass, BMKOpenOption>)
  end;
  ...
  TBMKOpenPanoramaOption = class(TOCGenericImport<BMKOpenPanoramaOptionClass,
  ...
  BMKOpenPanorama = interface(NSObject)
    ['{00A8394D-D685-4AC1-8B31-BEE517392A53}']
  ...
  TBMKOpenPoiNearbyOption = class(TOCGenericImport<BMKOpenPoiNearbyOptionClass,
  ...
  BMKOpenPoiClass = interface(NSObjectClass)
    ...
    { class } function openBaiduMapPoiDetailPage(option: BMKOpenPoiDetailOption)
      : BMKOpenErrorCode; cdecl;
    { class } function openBaiduMapPoiNearbySearch
      (option: BMKOpenPoiNearbyOption): BMKOpenErrorCode; cdecl;
  end;

  BMKOpenPoi = interface(NSObject)
    ['{50F793FC-491C-4DBC-AFFE-82483BEF2D2A}']
  end;
  ...
  TBMKOpenWalkingRouteOption = class
    (TOCGenericImport<BMKOpenWalkingRouteOptionClass,
    BMKOpenWalkingRouteOption>)
  end;
  ...
  TBMKOpenDrivingRouteOption = class
    (TOCGenericImport<BMKOpenDrivingRouteOptionClass,
  ...
  BMKOpenTransitRouteOption = interface(BMKOpenRouteOption)
    ...
    procedure setOpenTransitPolicy(openTransitPolicy
      : BMKOpenTransitPolicy); cdecl;

    function openTransitPolicy: BMKOpenTransitPolicy; cdecl;
  end;

  TBMKOpenTransitRouteOption = class
    (TOCGenericImport<BMKOpenTransitRouteOptionClass,
    BMKOpenTransitRouteOption>)
  end;
  ...
  BMKOpenRouteClass = interface(NSObjectClass)
    ...
    { class } function openBaiduMapWalkingRoute
      (option: BMKOpenWalkingRouteOption): BMKOpenErrorCode; cdecl;

    { class } function openBaiduMapTransitRoute
      (option: BMKOpenTransitRouteOption): BMKOpenErrorCode; cdecl;
    { class } function openBaiduMapDrivingRoute
      (option: BMKOpenDrivingRouteOption): BMKOpenErrorCode; cdecl;
  end;

  BMKOpenRoute = interface(NSObject)
    ['{957923F0-FD97-4342-8D62-F3D9B01A6E17}']
  end;
  ...
  BMKOpenPanoramaDelegate = interface(IObjectiveC)
    ...
    procedure onGetOpenPanoramaStatus(ecode: BMKOpenErrorCode); cdecl;
  end;
