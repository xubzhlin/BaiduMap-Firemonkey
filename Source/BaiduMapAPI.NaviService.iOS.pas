...
procedure TiOSBaiduMapNaviService.DoDestroyNavi;
begin
  FUIManager.exitPage(EN_BNavi_ExitAllVC, False, nil);
...
begin
  ...
  if FRoutePlan = nil then
    FRoutePlan:=TBNRoutePlanManagerProtocol.Wrap(TBNCoreServices.OCClass.RoutePlanService);
