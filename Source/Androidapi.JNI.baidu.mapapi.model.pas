...
type
  ...
  JPoint = interface(JObject)
    ...
    { Property Methods }
    function _Getx: Integer; cdecl;// I
    procedure _Setx(ax: Integer); cdecl;// (I)V
    function _Gety: Integer; cdecl;// I
    procedure _Sety(ay: Integer); cdecl;// (I)V
  ...
  JLatLng = interface(JObject)
    ...
    { Property Methods }
    function _Getlatitude: Double; cdecl;// D
    function _Getlongitude: Double; cdecl;// D
    function _GetlatitudeE6: Double; cdecl;// D
    function _GetlongitudeE6: Double; cdecl;// D
    ...
    property latitudeE6: Double read _GetlatitudeE6;
    property longitudeE6: Double read _GetlongitudeE6;
  end;
  ...
  JLatLngBounds = interface(JObject)
    ...
    { Property Methods }
    function _Getnortheast: JLatLng; cdecl;// Lcom/baidu/mapapi/model/LatLng;
    procedure _Setnortheast(anortheast: JLatLng); cdecl;
    // (Lcom/baidu/mapapi/model/LatLng;)V
    function _Getsouthwest: JLatLng; cdecl;// Lcom/baidu/mapapi/model/LatLng;
    procedure _Setsouthwest(asouthwest: JLatLng); cdecl;
    // (Lcom/baidu/mapapi/model/LatLng;)V
